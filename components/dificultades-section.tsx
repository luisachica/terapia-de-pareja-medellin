    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-8">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-4xl font-bold text-slate-800 mb-6">¿Estás pasando por dificultades en tu relación?</h2>
          <p className="text-slate-600">
            No te preocupes, es algo muy común y con nuestro acompañamiento verás grandes avances
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-x-12 gap-y-16">
          <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all border border-slate-100">
            <div className="flex gap-6">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500 to-pink-400 flex items-center justify-center text-white flex-shrink-0 shadow-md">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all border border-slate-100">
            <div className="flex gap-6">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-500 to-sky-400 flex items-center justify-center text-white flex-shrink-0 shadow-md">
                <Brain className="w-7 h-7" />
              </div>
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">Depresión y ansiedad</h3>
                <p className="text-slate-600 mb-3">
                  <strong className="text-sky-500">¿Te sientes triste, sin energía o desconectado?</strong> La depresión
                  puede manifestarse como una sensación constante de tristeza, pérdida de interés en actividades que
                  antes disfrutabas, cambios en el apetito y dificultad para dormir.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all border border-slate-100">
            <div className="flex gap-6">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-400 flex items-center justify-center text-white flex-shrink-0 shadow-md">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all border border-slate-100">
            <div className="flex gap-6">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-400 flex items-center justify-center text-white flex-shrink-0 shadow-md">
